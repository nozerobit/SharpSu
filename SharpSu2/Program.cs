    ...
    internal class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            else
            {
                ...
                {
                    SpawnConsole(options.user, options.pass, options.shell);
                }
        ...
        static void SpawnConsole(string user, string password, string shell)
        {
            bool bSuccess;
            ...
            Console.WriteLine("[+] CreateProcessWithLogonW() succeed!");
